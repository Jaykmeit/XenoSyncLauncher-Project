...
public partial class WizardWindow : Window
{
    ...
    private void CancelButton_Click(object sender, RoutedEventArgs e)
    {
        var result = MessageBox.Show(
            "�Seguro que quieres cancelar la configuraci�n inicial? XenoSync Launcher se cerrar�.",
    ...
    /// <summary>Botón de la barra de título personalizada: minimizar la ventana.</summary>
    private void BtnMinimize_Click(object sender, RoutedEventArgs e) => WindowState = WindowState.Minimized;

    /// <summary>Botón X de la barra de título personalizada: mismo comportamiento que Cancel (muestra la confirmación antes de cerrar).</summary>
    ...
    private async System.Threading.Tasks.Task FinishWizardAsync()
    {
        ...
        // sepa d�nde est� el directorio Modded, el Vanilla, etc.
